...
for {set i $step} {$i < $last} {set i [expr $i + $step]} {
	puts "\033\[0m\033\[1A\033\[K\033\[1A\033\[K\033\[1A\033\[K\033\[1A\033\[K\033\[1AReading file $i of $length\033\[8m"
	mol addfile [format "%s/%05d/%s" $path $i $infile];
}
puts"\033\[0m\033\[1A\033\[K\033\[1A\033\[K\033\[1A\033\[K\033\[1A\033\[K\033\[1A";
