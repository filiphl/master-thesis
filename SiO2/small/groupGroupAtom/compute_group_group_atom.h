...
ComputeStyle(group/group/atom,ComputeGroupGroupAtom)

#else

#ifndef LMP_COMPUTE_GROUP_GROUP_ATOM_H
#define LMP_COMPUTE_GROUP_GROUP_ATOM_H
...
class ComputeGroupGroupAtom : public ComputeGroupGroup {
 public:
  ComputeGroupGroupAtom(class LAMMPS *, int, char **);
  ~ComputeGroupGroupAtom();
  void compute_peratom() override;
  int nmax;
  double **carray;

 private:
  void pair_contribution() override;
};
}
#endif
#endif
