...
double PairVashishta::single(int i, int j, int itype, int jtype, double rsq,
                         double factor_coul, double factor_lj,
                         double &fforce)
{
    //int ijparam = elem2param[itype][jtype][jtype];
    int ijparam = elem2param[ map[itype] ][ map[jtype] ][ map[jtype] ];
    // void PairVashishta::twobody(const Param &param, double rsq, double &fforce,
  //                   int eflag, double &eng, bool tabulated)
    double energy = 0;
    twobody(params[ijparam], rsq, fforce, 1 /*eflag*/, energy/* evdwl */, false);
                       ...
                       double *fj, double *fk, int eflag, double &eng)
{
  ...
  /*three-body gjør masse greier. Slutten av funksjonen
  fj[0] = 0; fj[1] = 0; fj[2] = 0;
    fk[0] = 0; fk[1] = 0; fk[2] = 0;
    eng = 0;
    Sjekke med og uten three-body For aa se hvor viktig de er.
  */
