...
%Explenation - dip in normal force.
 ...
 Again, at this radial position there's bad foundation in the statistics, so I wont read too much into this, as it is not completely systematic. 
...
As a continuation of the simulation giving the resulting distributions shown, we may rise the sphere as well and study the difference in force interaction between the two cases. 
...
The result is shown in figure \ref{fig:hysteresis}


\begin{figure}
\centering
\includegraphics[width=0.7\linewidth]{figures/hysteresis/normal}
\caption{}
\label{fig:normal}
\end{figure}
