...
\begin{abstract}
LAMMPS is used to perform molecular dynamics simulations of a single spherical asperity indenting a flat substrate.
...
Radial distribution of contact forces is computed and compared to Hertz' theory.
The coefficient of static friction is estimated. It's shown that it increases and converges with increasing substrate thickness.
...
\begin{equation}
	p(r) = \frac{2aE^*}{\pi R}\sqrt{1-\frac{r^2}{a^2}}, \label{eq:HertzPressure}
\end{equation}
where $r$ is the radial distance to the center of the indentation.
...
The subscript $H$ indicates that this is Hertz prediction, as in \cite{Johnson1985}.
...
The field of friction is not new to science in any regard, however thanks the advances in technology and computational power, we are now able to simulate physical systems at an atomic level. 
A study, very similar to our, has been conducted by Binquan Luan and Mark Robbins \cite{RobbinsSingleAsperity}. 
They used LAMMPS to do molecular dynamics simulations of a single spherical asperity indenting a flat substrate. 
They measured pressure distribution in the area of contact, and compared it to solution predicted by Hertz' theory. 
They did this for differently constructed spheres: bent commensurate, bent uncommensurate, step... 
They found the step to deviate the most from the theory, having a much more linear behavior than the theory and the rest of the simulations.
They also noticed a dip in the pressure right at the center, obviously deviating from Hertz' theory. 
