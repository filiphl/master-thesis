...
It's shown that it increases and converges with increasing substrate thickness.
...
\begin{equation}
\mu = \frac{F}{L}, \label{eq:coefficientOfFriction2}
\end{equation}
or 
\begin{equation}
\mu' = \frac{dF}{dL}, \label{eq:coefficientOfFriction}
\end{equation}
It express how the static friction force $F$ increases with increasing load $L$.
The difference between the two definitions is that for the first, $F=0$ at $L=0$, while in the second, $F$ can be non-zero at $L=0$. 
