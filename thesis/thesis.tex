...
Molecular dynamics simulations are computational expensive, which the reason for the second point.
...
This algorithm in equation \eqref{eq:stromer-verlet} is known as Strömer-Verlet. 
It has a high order truncation error, however it may suffer from round-off errors. 
The last term is proportional to $\Delta t^2$, and is potentially much smaller than the other terms.
...
\begin{align}\label{eq:velocity-verlet2}
