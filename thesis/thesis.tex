...
\section{Microscopic aspects}
Friction is caused by electromagnetic interactions between atoms of the two bodies, at the area of contact. 
...
The bonds can brake either by applying an external force or by thermal excitation\footnote{Creep}.
Bonds will be formed and broken continuously (for temperatures $T>0K$).
However, these bonds are the source of the opposing force we refer to as friction.
