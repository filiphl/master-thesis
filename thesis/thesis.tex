...
It's shown that for thin substrates it increases linearly with the substrate thickness, in agreement with recent experiments conducted by Julien Scheibert at XXX.
...
\end{figure}
The coefficient of static friction seems to increase with the substrate thickness.
From the looks of the result, I am tempted to claim a linear relation, at least for this range of substrate thickness. 
...
Also, Robbins obtained a dip in the center of the radial pressure distribution, but did not address it. 
...
Obviously, the fact that we use materials of different properties should produce a difference in adhesion.
...
This dependence is to be in agreement with the experimental results of Julien Scheibert [REF]. 
...
Though we do not use an isotropic polymer, but a crystalline silica, we do see the same tendency. 
Though it is encouraging to see a simulation reproduce the results of a physical experiment, we need to be critical to the methods used in the measurements. 
For instance, Julien takes into account the changing area of contact in his measurements\footnote{The area of contact increases with substrate thickness.}, whereas we do not.
...
Since the resulting measurements for each velocity fit very well on a line, I do not suspect this to be a source of error.
