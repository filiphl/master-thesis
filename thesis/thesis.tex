...
\begin{figure}[H]
	...
	\caption{Distribution of force. The color at a square represents the time averaged magnitude (a) and z-component (b) of the contact force of atoms within the square, hence not dependent on direction.
		This is the result from a simulation where we push a sphere with radius of curvature $R=200$\AA  ~XX\AA ~into a half-space of area $46\times46$ unit cells}
...
\end{table}
\begin{figure}[H]
	\caption{Radial distribution of contact forces between a sphere with radius of curvature $R=200\mathring{A}$ and a substrate of size $327.52\mathring{A} \times 327.52\mathring{A} \times 156.64\mathring{A}$ at different depths of indentation $h$. 
