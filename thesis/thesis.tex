...
\begin{description}
	...
	\begin{description}
		...
		To distinguish the components of the contact forces, we must approximate the surface, in order to determine its gradient.
	\end{description}
...
There are many potential methodological errors that may arisen in our model.
When computing the force distribution for instance, the center of the indentation is defined to be in the center of the system. 
It does not account for the possibility that it might move, however slightly, du to atomic structure. 
...
Considering the differences in our models, it would be interesting to investigate the cause of the discrepancies. 
...
At this point we have a model which can be altered as desired, and be used for further studies of friction. 
