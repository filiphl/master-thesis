...
Though for solid state physics there are several algorithms which attempt at this by searching for areas with structural discrepancies and dislocations \cite{stukowski}. 
...
Secondly,  we compute the time-averaged force exerted on one body from another within each cell of the grid. 
